...
export const translations = {
  en: {
    ...
    problems: {
      ...
      sectionSubtitle: "Traditional BIM compliance is reactive, manual, and stressful. We make it proactive, automated, and intelligent.",
      ...
      p2Title: "Error-Prone",
      p2Desc: "Given the sheer complexity of BIM models and regulatory requirements, human error during manual checks is nearly unavoidable — leading to costly rework and project delays.",
  ...
  de: {
    ...
    problems: {
      ...
      sectionSubtitle: "Traditionelle BIM-Compliance ist reaktiv, manuell und stressig. Wir machen sie proaktiv, automatisiert und intelligent.",
      ...
      p2Desc: "Angesichts der enormen Komplexität von BIM-Modellen und regulatorischen Anforderungen sind menschliche Fehler bei manuellen Prüfungen nahezu unvermeidlich — was zu teuren Nacharbeiten und Projektverzögerungen führt.",
